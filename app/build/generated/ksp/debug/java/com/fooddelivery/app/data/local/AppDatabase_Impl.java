  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `restaurants` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `imageUrl` TEXT NOT NULL, `rating` REAL NOT NULL, `monthlySales` INTEGER NOT NULL, `deliveryTime` TEXT NOT NULL, `deliveryFee` REAL NOT NULL, `minPrice` REAL NOT NULL, `distance` REAL NOT NULL, `categories` TEXT NOT NULL, `description` TEXT NOT NULL, `isFavorite` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `dishes` (`id` INTEGER NOT NULL, `restaurantId` INTEGER NOT NULL, `name` TEXT NOT NULL, `description` TEXT NOT NULL, `imageUrl` TEXT NOT NULL, `price` REAL NOT NULL, `originalPrice` REAL, `categoryName` TEXT NOT NULL, `monthSales` INTEGER NOT NULL, `stock` INTEGER NOT NULL, `isRecommended` INTEGER NOT NULL, `packingFee` REAL NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `cart_items` (`id` INTEGER NOT NULL, `dishId` INTEGER NOT NULL, `restaurantId` INTEGER NOT NULL, `name` TEXT NOT NULL, `price` REAL NOT NULL, `packingFee` REAL NOT NULL, `imageUrl` TEXT NOT NULL, `quantity` INTEGER NOT NULL, `categoryName` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `addresses` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `phone` TEXT NOT NULL, `detailAddress` TEXT NOT NULL, `buildingInfo` TEXT, `floorInfo` TEXT, `doorplateInfo` TEXT, `addressTag` TEXT, `isDefault` INTEGER NOT NULL, `latitude` REAL, `longitude` REAL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `orders` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `orderNo` TEXT NOT NULL, `restaurantId` INTEGER NOT NULL, `restaurantName` TEXT NOT NULL, `totalAmount` REAL NOT NULL, `deliveryFee` REAL NOT NULL, `packingFee` REAL NOT NULL, `discountAmount` REAL NOT NULL, `actualAmount` REAL NOT NULL, `status` TEXT NOT NULL, `createTime` INTEGER NOT NULL, `payTime` INTEGER, `deliveryTime` INTEGER, `completeTime` INTEGER, `addressId` INTEGER NOT NULL, `addressDetail` TEXT NOT NULL, `receiverName` TEXT NOT NULL, `receiverPhone` TEXT NOT NULL, `items` TEXT NOT NULL, `riderName` TEXT, `riderPhone` TEXT, `estimatedDeliveryTime` TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'ce157b940c1fe1840bfa2ed8eeb29e5a')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsRestaurants = new HashMap<String, TableInfo.Column>(12);
        ...
        _columnsRestaurants.put("imageUrl", new TableInfo.Column("imageUrl", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsRestaurants.put("deliveryTime", new TableInfo.Column("deliveryTime", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsDishes.put("categoryName", new TableInfo.Column("categoryName", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsCartItems.put("categoryName", new TableInfo.Column("categoryName", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsAddresses = new HashMap<String, TableInfo.Column>(11);
        ...
        _columnsAddresses.put("phone", new TableInfo.Column("phone", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAddresses.put("detailAddress", new TableInfo.Column("detailAddress", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsOrders.put("orderNo", new TableInfo.Column("orderNo", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsOrders.put("createTime", new TableInfo.Column("createTime", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsOrders.put("addressDetail", new TableInfo.Column("addressDetail", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsOrders.put("receiverName", new TableInfo.Column("receiverName", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsOrders.put("receiverPhone", new TableInfo.Column("receiverPhone", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "ce157b940c1fe1840bfa2ed8eeb29e5a", "17508365287edbe3223d092031fcf347");
